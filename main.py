...
if __name__ == "__main__":
    ...
    is_short_link = check_link(token, version, key, extended, interval)
    if is_short_link:
        print(count_clicks(token, version, key, extended, interval))
    else:
        print(get_short_link(token, version, short_link, is_private))
